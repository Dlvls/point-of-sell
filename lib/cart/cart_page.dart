...
import 'check_box_page.dart'; // Ensure this is correctly imported
import 'counter_page.dart'; // Ensure this is correctly imported

class CartPage extends StatefulWidget {
  final String productId;

  CartPage({super.key, required this.productId});
                            ...
                            return ListTile(
                              title: DefaultTextStyle(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    CheckboxApp(
                                      onChanged: (isChecked, cartId) {
                                        setState(() {
                                          _checkedItems[cartId] = isChecked;
                                        });
                                      },
                                      cartItem: cartItem,
                          ...
                          children: [
                            ...
                            Expanded(
                              child: ElevatedButton(
                                onPressed: () {
                                  final checkedCartIds = _checkedItems.entries
                                      .where((entry) => entry.value)
                                      .map((entry) => entry.key)
                                      .toList();

                                  // Create a map to hold both values
                                  final extraData = {
                                    'checkedCartIds': checkedCartIds,
                                    'totalPrice': _totalPrice,
                                  };

                                  // Pass the map to the next page
                                  context.push(
                                    '/check_out',
                                    extra: extraData,
                                  );
